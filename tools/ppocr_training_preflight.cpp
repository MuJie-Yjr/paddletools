...
int main(int argc, char** argv) {
    ...
    QCoreApplication::setApplicationName(QStringLiteral("ppocr_training_preflight"));
    QCoreApplication::setApplicationVersion(QStringLiteral("0.1"));

    QCommandLineParser parser;
    parser.setApplicationDescription(QStringLiteral("Validate PaddleX training setup for a PPOCR workbench project."));
    ...
    try {
        ...
        const auto result = ppocr::TrainingPreflight::run(baseDir, context, taskKey, options);
